...
for idx in range (0, 1256):
    ...
    temp = -0.25686 + Apple.feature[1][idx]*-0.18745 + Apple.feature[2][idx]*0.24151 + Apple.feature[4][idx]*0.94114 + Apple.feature[-1][idx]*-1.86253e-9 + Adobe.feature[4][idx]*0.02041 + Google.feature[1][idx]*-0.02786 + Google.feature[3][idx]*0.02511 + Microsoft.feature[-1][idx]*5.05086e-9 + Qualcomm.feature[3][idx]*-0.10377 + Qualcomm.feature[4][idx]*0.11060 + TI.feature[-1][idx]*4.045208e-8
    pred.append(temp)
